...
exports.default = new cmd_1.MessageCommand()
    .setName(`Play`)
    .setGuildOnly(true)
    ...
    if (!query.length)
        throw new Error(`Unable to find content in the targeted message`);
    ...
    if (!search.tracks.length)
        throw new Error(`No tracks found for query "${(0, cmd_1.cleanseMarkdown)(query)}"`);
