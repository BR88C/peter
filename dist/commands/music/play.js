...
exports.default = new cmd_1.ChatCommand()
    ...
    const searchingMessage = await ctx.send(new cmd_1.Embed()
        .setColor(cmd_1.DiscordColors.ROLE_YELLOW)
        .setTitle(`:mag_right:  Searching for "${(0, cmd_1.cleanseMarkdown)(ctx.parameters.query)}"...`));
    ...
    if (search.loadType === `PLAYLIST_LOADED`) {
        await ctx.edit(searchingMessage, new cmd_1.Embed()
