...
exports.default = new cmd_1.ChatCommand()
    ...
    .addNumberParameter(false, `frequency`, `The frequency to fluctuate the pitch at; the default is ${Constants_1.Constants.TREMOLO_VIBRATO_FREQUENCY}`, {
    min: 0.001,
    max: 14
})
    ...
    const newFilters = {
        ...
        vibrato: {
            ...
            frequency: (ctx.parameters.frequency ?? player.filters.vibrato?.frequency) ?? Constants_1.Constants.TREMOLO_VIBRATO_FREQUENCY
        }
    };
