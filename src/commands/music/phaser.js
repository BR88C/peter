...
module.exports = {
    ...
    execute: async (client, message, args) => {
        ...
        if (message.member.voice.channelID !== serverQueue.voiceChannel.id) return message.reply(`you need to be in the same voice channel as me to add a phaser effect!`);
