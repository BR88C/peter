...
module.exports = {
    ...
    execute: async (client, message, args) => {
        ...
        if (message.member.voice.channelID !== serverQueue.voiceChannel.id) return message.reply(`you need to be in the same voice channel as me to resume the music!`);
        ...
        if (serverQueue && !serverQueue.playing) { // Checks if the the music is paused.
        ...
        } else { // If the music is already resumed.
