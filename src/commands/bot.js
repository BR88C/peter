	...
	async execute(client, message, args) {
        ...
        let botInfoEmbed = new Discord.MessageEmbed()
            ...
            .addFields(
                ...
                { name: `**Author**`, value: client.config.devs.tags.join(`, `), inline: true },
                { name: `**Ping**`, value: `${Math.round(100*client.ws.ping)/100}ms`, inline: true },
                { name: `**Uptime**`, value: uptime, inline: true },
                { name: `**Support Server**`, value: client.config.links.supportServer, inline: true },
                { name: `**Repository**`, value: client.pjson.repository.url.replace(`git+`, ``), inline: true },
